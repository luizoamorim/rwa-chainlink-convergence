...
// VehicleTokenConsumerMock is a mock implementation of VehicleTokenConsumer for testing.
type VehicleTokenConsumerMock struct {
	...
	VehicleNFT              func() (common.Address, error)
}

// NewVehicleTokenConsumerMock creates a new VehicleTokenConsumerMock for testing.
func NewVehicleTokenConsumerMock(address common.Address, clientMock *evmmock.ClientCapability) *VehicleTokenConsumerMock {
	mock := &VehicleTokenConsumerMock{}
	...
	funcMap := map[string]func([]byte) ([]byte, error){
		...
		string(abi.Methods["vehicleNFT"].ID[:4]): func(payload []byte) ([]byte, error) {
			if mock.VehicleNFT == nil {
				return nil, errors.New("vehicleNFT method not mocked")
			}
			result, err := mock.VehicleNFT()
			if err != nil {
				return nil, err
			}
			return abi.Methods["vehicleNFT"].Outputs.Pack(result)
		},
	}
